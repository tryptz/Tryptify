...
fun SpotifyPlaylistPickerDialog(
    ...
    Dialog(
        ...
        // Opaque, for the reason CreatePlaylistDialog is: a dialog is its own
        // window, the backdrop belongs to the window behind it, and a haze
        // effect cannot sample another window's layer. Asking liquidGlass for
        // glass here left a translucent tint over the library with this
        // dialog's text on top of it.
        Surface(
            modifier = Modifier
                .fillMaxWidth(0.9f)
                .wrapContentHeight()
