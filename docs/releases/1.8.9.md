...
- **Exclusive USB DAC output works.** Tryptify talks to the DAC over UAC2 itself, so audio skips Android's mixer and its resampler entirely. The DAC runs at the file's own rate and gets the samples untouched.
